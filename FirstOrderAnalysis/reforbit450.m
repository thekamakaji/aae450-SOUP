...
orb_Tx_a = 26600 + R_E; % Orbit radius [km]
orb_Tx_e = 0; % Eccentricity
orb_Tx_i = 55; % Inclination [deg.]
orb_Tx_RAAN = 0; % Right Ascension of AN [deg.]
orb_Tx_P = 1; % Orbital Period [days]

% Keplerian Orbit of Receiver (Rx) Satellite - HARDCODE
orb_Rx_a = 900 + R_E; % Orbit radius [km]
orb_Rx_e = 0; % Eccentricity
orb_Rx_i = 98; % Inclination [deg.]
